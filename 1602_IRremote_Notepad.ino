 ...
 * RIGHT Key - Adds new space character 
 * LEFT Key - clear current character, go back one character
 * OK Key - Locks message, requires reset to continue
 * '*' Key - Adds new alpha character
 * '0' Key - Adds new numeric character
 * '#' Key - Adds new punctuation character
 * '1' Key - -4 from current char (medium down)
 * '3' Key - +4 to current char (medium up)
 * '4' Key - -8 from current char (large down)
 * '5' Key - Clears screen and starts over
 * '6' Key - +8 to current char (large up)
 * '7' Key - Converts uppercase to lowercase
 * '9' Key - Converts lowercase to uppercase
 * 
